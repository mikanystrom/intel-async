...
\bibitem{cspref}
M.~Nystr\"om,
\emph{Fulcrum CSP Reference Manual},
Intel Labs, 2024.
Included in the async-toolkit distribution: \texttt{csp/doc/csp/}.

\bibitem{mscheme}
M.~Nystr\"om,
``mscheme: A Scheme Interpreter Embedded in Modula-3,''
Part of the CM3 distribution: \texttt{m3-scheme/mscheme/}.
\url{https://github.com/modula3/cm3}

\bibitem{modula3}
L.~Cardelli, J.~Donahue, L.~Glassman, M.~Jordan, B.~Kalsow, G.~Nelson,
``Modula-3 Language Definition,''
\emph{ACM SIGPLAN Notices}, vol.~27, no.~8, pp.~15--42, 1992.
See also: \url{https://www.modula3.org}

\bibitem{cm3}
Critical Mass, Inc.\ and contributors,
``CM3: Critical Mass Modula-3 Compiler and Runtime,''
\url{https://github.com/modula3/cm3}
