...
channels~\cite{manohar2001}.  This property has been studied
extensively: Papadantonakis~\cite{papadantonakis2002} examined the
precise conditions under which deterministic CHP programs are slack
elastic, and Prakash~\cite{prakash2008} showed that the slack
