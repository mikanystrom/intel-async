...
gnuplot.  Source code is available at:
\begin{center}
\url{https://github.com/mikanystrom/intel-async/tree/al-ga-surface-analysis}
\end{center}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figures/face5_curvature_anomalies.pdf}
\caption{Mean curvature $H$ (mm$^{-1}$) for Face~5, with anomalies
  ...
  recommendations of Nystr\"om (2008).}
\label{fig:curvature}
\end{figure}
...
of the same face into frequency bands.  The coarsest level
captures the overall shape (a gentle bowl with ${\sim}500$~$\mu$m
peak-to-peak).  Successive bands reveal medium-scale undulations
and fine-scale roughness.  The finest band shows features
at the grid resolution (${\sim}5$~$\mu$m), where particle
inclusions and polishing artifacts are most visible.

\begin{figure}[p]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figures/face5_spectral.pdf}
\caption{Multiresolution height field decomposition of Face~5.
  Top-left: coarsest smoothed level.
  Remaining panels: band-pass differences between successive
  smoothing levels, from low frequency to the finest
  detail.  Color scales decrease by approximately $2\times$
...
\begin{figure}[p]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{figures/face5_height.pdf}
...
are in micrometers.  Axis scales are identical in $x$ and $y$.

\clearpage
\subsection*{Sample 550\_1\_1}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-1.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-2.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-3.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-4.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-5.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-6.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-7.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-1-Face-8.png}\end{center}

\clearpage
\subsection*{Sample 550\_1\_2}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-1.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-2.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-3.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-4.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-5.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-6.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-7.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-8.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-9.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-10.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-11.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-2-Face-12.png}\end{center}

\clearpage
\subsection*{Sample 550\_1\_3}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-1.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-2.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-3.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-4.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-5.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-6.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-7.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-8.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-3-Face-9.png}\end{center}

\clearpage
\subsection*{Sample 550\_1\_4}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-1.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-2.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-3.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-4.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-5.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-6.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-7.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-8.png}\end{center}
\begin{center}\includegraphics[width=0.75\textwidth]{figures/550-1-4-Face-9.png}\end{center}
...
Reference Manual'' (Nystr\"om, 2008): a diverging palette with a
