...
$(i,j)$ in the two adjacent triangles, and $A_i$ is the mixed
Voronoi area (approximated here as one-third of the total incident
face area).  This formula has units of $1/\text{length}$---the
...
\item \textbf{Voronoi area.}  Replace the $A_i/3$ barycentric
  approximation with the proper mixed Voronoi area of
  Meyer et al.\ (2003) for more accurate curvature at obtuse
  triangles.
\end{itemize}
